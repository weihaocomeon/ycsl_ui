...
export function removeElementAuthority(id, data) {
  return request({
    url: 'api/group/' + id + '/authority/element/remove',
    method: 'post',
    params: data
  })
}
...
export function addElementAuthority(id, data) {
  return request({
    url: 'api/group/' + id + '/authority/element/add',
    method: 'post',
    params: data
  })
}
...
export function getElementAuthority(id) {
  return request({
    url: 'api/group/' + id + '/authority/element',
    method: 'get'
  });
}
...
export function modifyMenuAuthority(id, data) {
  return request({
    url: 'api/group/' + id + '/authority/menu',
    method: 'post',
    params: data
  });
}
...
export function removeElementAuthorize(id, data) {
  return request({
    url: 'api/group/' + id + '/authorize/element/remove',
    method: 'post',
    params: data
  })
}
...
export function addElementAuthorize(id, data) {
  return request({
    url: 'api/group/' + id + '/authorize/element/add',
    method: 'post',
    params: data
  })
}
...
export function getElementAuthorize(id) {
  return request({
    url: 'api/group/' + id + '/authorize/element',
    method: 'get'
  });
}
...
export function modifyMenuAuthorize(id, data) {
  return request({
    url: 'api/group/' + id + '/authorize/menu',
    method: 'post',
    params: data
  });
}
...
export function pageAuthorize(query) {
  return request({
    url: 'api/group/element/authorize/list',
    method: 'get',
    params: query
  })
}
...
export function fetchAuthorizeTree() {
  return request({
    url: 'api/group/menu/authorize/list',
    method: 'get'
  })
}